...
if st.sidebar.button("Realizar Consulta"):
    ...
    # Obtener la colección MongoDB después de que el usuario haya ingresado los parámetros
...
#st.sidebar.header("Diseño de la barra lateral")
# Puedes agregar más elementos de diseño aquí según sea necesario

# Contenido principal en el área principal (derecha)
#st.title("Bienvenido a Relatoría")

# Aquí puedes agregar más contenido principal según sea necesario
